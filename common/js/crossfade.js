...
var CrossfadeSample = function() {
  loadSounds(this, {
    sig0: './common/audio/org/signal_0_short_fade.wav',
    sig45: './common/audio/org/signal_-45_short_fade.wav',
    sig90: './common/audio/org/signal_-90_short_fade.wav',
    sig135: './common/audio/org/signal_-135_short_fade.wav',
    sig180: './common/audio/org/signal_180_short_fade.wav',
    sig_135: './common/audio/org/signal_135_short_fade.wav',
    sig_90: './common/audio/org/signal_90_short_fade.wav',
    sig_45: './common/audio/org/signal_45_short_fade.wav',
    sig0_a: './common/audio/trans/signal_0_short_fade.wav',
    sig45_a: './common/audio/trans/signal_-45_short_fade.wav',
    sig90_a: './common/audio/trans/signal_-90_short_fade.wav',
    sig135_a: './common/audio/trans/signal_-135_short_fade.wav',
    sig180_a: './common/audio/trans/signal_180_short_fade.wav',
    sig_135_a: './common/audio/trans/signal_135_short_fade.wav',
    sig_90_a: './common/audio/trans/signal_90_short_fade.wav',
    sig_45_a: './common/audio/trans/signal_45_short_fade.wav',
    sig0_b: './common/audio/1storder/signal_0_short_fade.wav',
    sig45_b: './common/audio/1storder/signal_-45_short_fade.wav',
    sig90_b: './common/audio/1storder/signal_-90_short_fade.wav',
    sig135_b: './common/audio/1storder/signal_-135_short_fade.wav',
    sig180_b: './common/audio/1storder/signal_180_short_fade.wav',
    sig_135_b: './common/audio/1storder/signal_135_short_fade.wav',
    sig_90_b: './common/audio/1storder/signal_90_short_fade.wav',
    sig_45_b: './common/audio/1storder/signal_45_short_fade.wav'
  });
...
CrossfadeSample.prototype.play = function(element,position) {
  ...
  if(position == "1"){
    this.ctl1.gainNode.gain.value = 3*gain1;
    this.ctl2.gainNode.gain.value = 3*gain2;
    this.ctl3.gainNode.gain.value = 3*gain3;
    this.ctl4.gainNode.gain.value = 3*gain4;
    this.ctl5.gainNode.gain.value = 3*gain5;
    this.ctl6.gainNode.gain.value = 3*gain6;
    this.ctl7.gainNode.gain.value = 3*gain7;
    this.ctl8.gainNode.gain.value = 3*gain8;
    ...
    this.ctl9.gainNode.gain.value = 3*gain1;
    this.ctl10.gainNode.gain.value = 3*gain2;
    this.ctl11.gainNode.gain.value = 3*gain3;
    this.ctl12.gainNode.gain.value = 3*gain4;
    this.ctl13.gainNode.gain.value = 3*gain5;
    this.ctl14.gainNode.gain.value = 3*gain6;
    this.ctl15.gainNode.gain.value = 3*gain7;
    this.ctl16.gainNode.gain.value = 3*gain8;
    this.ctl17.gainNode.gain.value = 0;
    this.ctl18.gainNode.gain.value = 0;
    this.ctl19.gainNode.gain.value = 0;
    this.ctl20.gainNode.gain.value = 0;
    ...
    this.ctl15.gainNode.gain.value = 0;
    this.ctl16.gainNode.gain.value = 0;
    this.ctl17.gainNode.gain.value = 3*gain1;
    this.ctl18.gainNode.gain.value = 3*gain2;
    this.ctl19.gainNode.gain.value = 3*gain3;
    this.ctl20.gainNode.gain.value = 3*gain4;
    this.ctl21.gainNode.gain.value = 3*gain5;
    this.ctl22.gainNode.gain.value = 3*gain6;
    this.ctl23.gainNode.gain.value = 3*gain7;
    this.ctl24.gainNode.gain.value = 3*gain8;
  }
